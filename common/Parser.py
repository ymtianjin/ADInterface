...
class Parser:
    def __init__(self, param):
        ...
        self.appKey = ""
        self.channelCode = ""
        self.indexUrl = str(param.__contains__("global_index_url") and param["global_index_url"] or "")
        self.pageUrl = str(param.__contains__("global_page_url") and param["global_page_url"] or "")
        self.contentUrl = str(param.__contains__("global_content_url") and param["global_content_url"] or "")
        self.subcontentUrl = str(param.__contains__("global_subcontent_url") and param["global_subcontent_url"] or "")
        self.categoryTreeUrl = str(param.__contains__("global_category_tree_url") and param["global_category_tree_url"] or "")
        self.appKey = str(param.__contains__("global_app_key") and param["global_app_key"] or "")
        self.channelCode = str(param.__contains__("global_channel_code") and param["global_channel_code"] or "")
        self.channel = {}
        self.program = []
        self.category = {}
